...
b2PolygonAndCircleContact::b2PolygonAndCircleContact(const b2PolygonAndCircleContact* other,
...
size_t b2PolygonAndCircleContact::Size() const {
    return sizeof(b2PolygonAndCircleContact);
}

void b2PolygonAndCircleContact::CopyConstructInto(b2Contact* target,
        const std::unordered_map<b2Body*, b2Body*>& newBodies,
        const std::unordered_map<b2Fixture*, b2Fixture*>& newFixtures,
        const std::unordered_map<b2Joint*, b2Joint*>& newJoints,
        const std::unordered_map<b2JointEdge*, b2JointEdge*>& newJointEdges,
    ...
    new (target) b2PolygonAndCircleContact(this, newBodies, newFixtures, newJoints, newJointEdges, newContacts, newContactEdges);
}
